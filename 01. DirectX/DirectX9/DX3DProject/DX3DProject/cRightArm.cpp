...
void cRightArm::Setup()
{
	cCubeNode::Setup();
    {
        ...
        m_vecVertex[20].t.x = (float)40 / 64;   m_vecVertex[14].t.y = (float)20 / 32;
        ...
        m_vecVertex[23].t.x = (float)40 / 64;   m_vecVertex[17].t.y = (float)32 / 32;
        ...
        m_vecVertex[14].t.x = (float)48 / 64;   m_vecVertex[20].t.y = (float)20 / 32;
        ...
        m_vecVertex[17].t.x = (float)48 / 64;   m_vecVertex[23].t.y = (float)32 / 32;
        ...
        m_vecVertex[26].t.x = (float)44 / 64;   m_vecVertex[26].t.y = (float)16 / 32;
        ...
        m_vecVertex[29].t.x = (float)44 / 64;   m_vecVertex[29].t.y = (float)20 / 32;
        ...
        m_vecVertex[32].t.x = (float)48 / 64;   m_vecVertex[32].t.y = (float)20 / 32;
        ...
        m_vecVertex[35].t.x = (float)48 / 64;   m_vecVertex[35].t.y = (float)16 / 32;
    }
